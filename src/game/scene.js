...
export class ReskinLabScene extends Phaser.Scene {
  constructor() {
    super("ReskinLabScene");
  }

  preload() {
    const config = globalThis.reskinLabRuntime.config;
  ...
  create() {
    const runtime = globalThis.reskinLabRuntime;
